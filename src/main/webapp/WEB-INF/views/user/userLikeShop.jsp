...
<html lang="ko">
    <head>
        ...
        <title>나의 관심점포</title>
        <link rel="stylesheet" href="/resources/css/user/userLike.css">
        ...
        <div id="container">
            ...
            <main>
                ...
                <div id="user-info-edit-box">
                    <div id="user-shop">
                        <h1 class="middle-title">관심 식당 및 카페</h1>
                        <h2 class="small-title">관심 식당</h2>
                        <div id="shop-div" class="div">
                            <div id="shop1" class="shop-box">
                                <img src="/resources/images/mainPage/beef-noodle.PNG" alt="우육면" class="img">
                            ...
                            <div id="shop2" class="shop-box">
                                <img src="/resources/images/mainPage/camping.jpg" alt="삼겹살" class="img">
                                <div class="display-box">
                                    <div>
                                        <h3>캠핑그리들 210도씨</h3>
                                        <p>점수 : 4.58</p>
                            ...
                            <div id="shop3" class="shop-box">
                                <img src="/resources/images/mainPage/beef-steak.PNG" alt="소고기" class="img">
                                <div class="display-box">
                                    <div>
                                        <h3>일편등심</h3>
                                        <p>점수 : 4.4</p>
                        ...
                        <h2 class="small-title">관심 카페</h2>
                        <div id="cafe-div" class="div">
                            <div id="cafe1" class="cafe-box">
                                <img src="/resources/images/mainPage/foluite.jpg" alt="카페 폴루이트" class="img">
                                <div class="display-box">
                                    <div>
                                        <h3>카페 폴루이트</h3>
                                        <p>점수 : 4.5</p>
                            ...
                            <div id="cafe2" class="cafe-box">
                                <img src="/resources/images/mainPage/paulbassett.PNG" alt="폴 바셋" class="img">
                                <div class="display-box">
                                    <div>
                                        <h3>폴 바셋</h3>
                                        <p>점수 : 4.1</p>
                            ...
                            <div id="cafe3" class="cafe-box">
                                <img src="/resources/images/mainPage/cafe-jongnosijang.PNG" alt="카페 종로시장" class="img">
                                <div class="display-box">
                                    <div>
                                        <h3>카페 종로시장</h3>
                                        <p>점수 : 4.4</p>
